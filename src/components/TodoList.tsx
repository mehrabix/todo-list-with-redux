  ...
  return (
    <div>
      <div className='flex flex-wrap justify-center my-5 gap-4'>
        <button className='bg-slate-300 px-2 py-1 rounded-md' onClick={() => setSortByCompleted(false)}>
          Sort by Creation Time
        </button>
        <button className='bg-slate-300 px-2 py-1 rounded-md' onClick={() => setSortByCompleted(true)}>
